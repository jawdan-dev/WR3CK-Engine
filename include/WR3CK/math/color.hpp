...
public:
	...
	WR3CK_GETTER_CONST(uint8_t, r8, static_cast<uint8_t>(static_cast<float>(0xff) * m_r));
	WR3CK_GETTER_CONST(uint8_t, g8, static_cast<uint8_t>(static_cast<float>(0xff) * m_g));
	WR3CK_GETTER_CONST(uint8_t, b8, static_cast<uint8_t>(static_cast<float>(0xff) * m_b));
	WR3CK_GETTER_CONST(uint8_t, a8, static_cast<uint8_t>(static_cast<float>(0xff) * m_a));
